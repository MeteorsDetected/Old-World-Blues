...
/vs_control/proc/ChangeSetting(mob/user,ch)
	...
	world << SPAN_NOTE("<b>[key_name(user)] changed the setting [display_description] to [newvar].</b>")
	if(ch in plc.settings)
