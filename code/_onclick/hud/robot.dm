...
//Radio
	...
	using.icon = 'icons/screen/robot.dmi'
...
//Cell
	...
	mymob:cells.icon = 'icons/screen/robot.dmi'
...
//Health
	...
	mymob.healths.icon = 'icons/screen/robot.dmi'
...
//Installed Module
	...
	mymob.hands.icon = 'icons/screen/robot.dmi'
...
//Store
	...
	mymob.throw_icon.icon = 'icons/screen/robot.dmi'
...
//Inventory
	...
	robot_inventory.icon = 'icons/screen/robot.dmi'
...
//remove because no need
	...
	//mymob.oxygen.icon = 'icons/screen/robot.dmi'
...
//remove because no need
	...
	//mymob.fire.icon = 'icons/screen/robot.dmi'
	//mymob.fire.icon_state = "fire0"
	//mymob.fire.name = "fire"
	//mymob.fire.screen_loc = ui_fire

	mymob.pullin = new /obj/screen()
	mymob.pullin.icon = 'icons/screen/robot.dmi'
	...
	mymob.flash.icon = 'icons/screen/robot.dmi'
	...
	mymob.zone_sel.icon = 'icons/screen/robot.dmi'
