/datum/hud/proc/larva_hud()
	...
	using.icon = 'icons/screen/alien.dmi'
	...
	mymob.healths.icon = 'icons/screen/alien.dmi'
	...
	mymob.flash.icon = 'icons/screen/alien.dmi'
	...
	mymob.fire.icon = 'icons/screen/alien.dmi'
