...
/datum/medical_effect/cramps/on_life(mob/living/carbon/human/H, strength)
	switch(strength)
		...
		if(31 to INFINITY)
			H.custom_emote(MESSAGE_VISIBLE, "flinches as all the muscles in their body cramp up.")
...
/datum/medical_effect/itch/on_life(mob/living/carbon/human/H, strength)
	switch(strength)
		...
		if(31 to INFINITY)
			H.custom_emote(MESSAGE_VISIBLE,"shivers slightly.")
