...
/datum/design/circuit/mechfab
	...
	id = "mechfab"
	category = "Mechas"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_ENGINEERING) = 3)
...
/datum/design/circuit/mecha/gygax_targ
	...
	id = "gygax_targ"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_COMBAT) = 2)
