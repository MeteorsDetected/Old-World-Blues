...
/datum/design/organ_module/armblade
	...
	req_tech = list(TECH(T_MATERIAL) = 3, TECH(T_COMBAT) = 4, TECH(T_BIO) = 4)
...
/datum/design/organ_module/armor
	...
	req_tech = list(TECH(T_MATERIAL) = 4, TECH(T_COMBAT) = 2, TECH(T_BIO) = 4)
...
/datum/design/prosthesis/enforcer
	req_tech = list(TECH(T_MATERIAL) = 3, TECH(T_ENGINEERING) = 2, TECH(T_COMBAT) = 2, TECH(T_BIO) = 3)
...
/datum/design/prosthesis/runner
	req_tech = list(TECH(T_MATERIAL) = 3, TECH(T_ENGINEERING) = 2, TECH(T_BIO) = 3)
