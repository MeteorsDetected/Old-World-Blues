...
/datum/design/circuit/aicore
	name = "AI core"
	id = "aicore"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_BIO) = 3)
	build_path = /obj/item/weapon/circuitboard/aicore

/datum/design/circuit/aiupload
	name = "AI upload console"
	id = "aiupload"
	req_tech = list(TECH(T_DATA) = 4)
...
/datum/design/circuit/teleconsole
	...
	id = "teleconsole"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_BLUESPACE) = 2)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/rcon_console
	...
	id = "rcon_console"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_ENGINEERING) = 3, TECH(T_POWER) = 5)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/gas_heater
	...
	id = "gasheater"
	req_tech = list(TECH(T_POWER) = 2, TECH(T_ENGINEERING) = 1)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/shield
	req_tech = list(TECH(T_BLUESPACE) = 4, TECH(T_PHORON) = 3)
...
/datum/design/circuit/shield/capacitor
	...
	id = "shield_cap"
	req_tech = list(TECH(T_MAGNET) = 3, TECH(T_POWER) = 4)
	build_path = /obj/item/weapon/circuitboard/shield_cap

/datum/design/circuit/aifixer
	name = "AI integrity restorer"
	id = "aifixer"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_BIO) = 2)
...
/datum/design/circuit/crewconsole
	...
	id = "crewconsole"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_MAGNET) = 2, TECH(T_BIO) = 2)
	category = TECH(T_BIO)
...
/datum/design/circuit/clonecontrol
	...
	id = "clonecontrol"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_BIO) = 3)
	category = TECH(T_BIO)
...
/datum/design/circuit/bioprinter
	name = "bioprinter"
	id = "bioprinter"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_BIO) = 5)
	category = TECH(T_BIO)
...
/datum/design/circuit/tcommsat
	category = "Telecomms"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_ENGINEERING) = 4)
...
/datum/design/circuit/tcommsat/relay
	...
	id = "tcom-relay"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_ENGINEERING) = 4, TECH(T_BLUESPACE) = 3)
	build_path = /obj/item/weapon/circuitboard/telecomms/relay

/datum/design/circuit/tcommsat/broadcaster
	name = "subspace broadcaster"
	id = "tcom-broadcaster"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_ENGINEERING) = 4, TECH(T_BLUESPACE) = 2)
	build_path = /obj/item/weapon/circuitboard/telecomms/broadcaster

/datum/design/circuit/tcommsat/receiver
	name = "subspace receiver"
	id = "tcom-receiver"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_ENGINEERING) = 3, TECH(T_BLUESPACE) = 2)
	build_path = /obj/item/weapon/circuitboard/telecomms/receiver

/datum/design/circuit/tcommsat/bluespacerelay
	name = "emergency bluespace relay"
	id = "bluespace-relay"
	req_tech = list(TECH(T_DATA) = 4, TECH(T_BLUESPACE) = 4)
...
/datum/design/circuit/destructive_analyzer
	...
	req_tech = list(TECH(T_DATA) = 2, TECH(T_MAGNET) = 2, TECH(T_ENGINEERING) = 2)
	build_path = /obj/item/weapon/circuitboard/destructive_analyzer

/datum/design/circuit/protolathe
	name = "protolathe"
	id = "protolathe"
	req_tech = list(TECH(T_DATA) = 2, TECH(T_ENGINEERING) = 2)
...
/datum/design/circuit/autolathe/industrial
	...
	req_tech = list(TECH(T_DATA) = 3, TECH(T_ENGINEERING) = 4)
...
/datum/design/circuit/recharge_station
	...
	id = "recharge_station"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_ENGINEERING) = 2)
...
/datum/design/circuit/pacman
	...
	id = "pacman"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_PHORON) = 3, TECH(T_POWER) = 3, TECH(T_ENGINEERING) = 3)
	reliability_base = 79
	materials = list(MATERIAL_GLASS = 2000)
	chemicals = list("sacid" = 20)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/superpacman
	...
	id = "superpacman"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_POWER) = 4, TECH(T_ENGINEERING) = 4)
	reliability_base = 76
	materials = list(MATERIAL_GLASS = 2000)
	chemicals = list("sacid" = 20)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/mrspacman
	...
	id = "mrspacman"
	req_tech = list(TECH(T_DATA) = 3, TECH(T_POWER) = 5, TECH(T_ENGINEERING) = 5)
	reliability_base = 74
	materials = list(MATERIAL_GLASS = 2000)
	chemicals = list("sacid" = 20)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/batteryrack
	name = "cell rack PSU"
	id = "batteryrack"
	req_tech = list(TECH(T_POWER) = 3, TECH(T_ENGINEERING) = 2)
	materials = list(MATERIAL_GLASS = 2000)
	chemicals = list("sacid" = 20)
	category = TECH(T_ENGINEERING)
...
/datum/design/circuit/smes_cell
	...
	id = "smes_cell"
	req_tech = list(TECH(T_POWER) = 7, TECH(T_ENGINEERING) = 5)
