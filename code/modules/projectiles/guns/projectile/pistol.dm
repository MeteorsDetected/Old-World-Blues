/obj/item/weapon/gun/projectile/colt
	...
	icon_state = "colt"
	caliber = ".45"
	origin_tech = list(TECH(T_COMBAT) = 2, TECH(T_MATERIAL) = 2)
...
/obj/item/weapon/gun/projectile/silenced
	...
	caliber = ".45"
	silenced = 1
	origin_tech = list(TECH(T_COMBAT) = 2, TECH(T_MATERIAL) = 2, TECH(T_ILLEGAL) = 8)
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/c45m
...
/obj/item/weapon/gun/projectile/gyropistol
	...
	origin_tech = list(TECH(T_COMBAT) = 3)
...
/obj/item/weapon/gun/projectile/pistol
	...
	caliber = "9mm"
	silenced = 0
	origin_tech = list(TECH(T_COMBAT) = 2, TECH(T_MATERIAL) = 2, TECH(T_ILLEGAL) = 2)
