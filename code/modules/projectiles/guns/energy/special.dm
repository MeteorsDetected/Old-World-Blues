/obj/item/weapon/gun/energy/ionrifle
	...
	origin_tech = list(TECH(T_COMBAT) = 2, TECH(T_MAGNET) = 4)
...
/obj/item/weapon/gun/energy/decloner
	...
	origin_tech = list(TECH(T_COMBAT) = 5, TECH(T_MATERIAL) = 4, TECH(T_POWER) = 3)
	max_shots = 10
...
/obj/item/weapon/gun/energy/floragun
	...
	origin_tech = list(TECH(T_MATERIAL) = 2, TECH(T_BIO) = 3, TECH(T_POWER) = 3)
...
/obj/item/weapon/gun/energy/toxgun
	...
	origin_tech = list(TECH(T_COMBAT) = 5, TECH(T_PHORON) = 4)
