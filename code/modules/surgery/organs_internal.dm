...
/datum/surgery_step/internal/remove_embryo
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			"[user] starts to pull something out from [target]'s ribcage with \the [tool].",
			"You start to pull something out from [target]'s ribcage with \the [tool]."
		)
...
/datum/surgery_step/internal/detatch_organ
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		user.visible_message(
			"[user] starts to separate [target]'s [target.op_stage.current_organ] with \the [tool].",
...
/datum/surgery_step/internal/remove_organ
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			"[user] starts removing [target]'s [target.op_stage.current_organ] with \the [tool].",
...
/datum/surgery_step/internal/replace_organ
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			"[user] starts transplanting \the [tool] into [target]'s [affected.name].",
...
/datum/surgery_step/internal/attach_organ
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			"[user] begins reattaching [target]'s [target.op_stage.current_organ] with \the [tool].",
