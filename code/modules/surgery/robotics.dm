...
/datum/surgery_step/robotics/unscrew_hatch
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_NOTE("[user] has opened the maintenance hatch on [target]'s [affected.name] with \the [tool]."),
			SPAN_NOTE("You have opened the maintenance hatch on [target]'s [affected.name] with \the [tool].")
		)
		affected.open = 1
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_WARN("[user]'s [tool.name] slips, failing to unscrew [target]'s [affected.name]."),
			SPAN_WARN("Your [tool] slips, failing to unscrew [target]'s [affected.name].")
		)
...
/datum/surgery_step/robotics/open_hatch
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_NOTE("[user] opens the maintenance hatch on [target]'s [affected.name] with \the [tool]."),
			SPAN_NOTE("You open the maintenance hatch on [target]'s [affected.name] with \the [tool].")
		)
		affected.open = 3
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_WARN("[user]'s [tool.name] slips, failing to open the hatch on [target]'s [affected.name]."),
			SPAN_WARN("Your [tool] slips, failing to open the hatch on [target]'s [affected.name].")
		)
...
/datum/surgery_step/robotics/close_hatch
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_NOTE("[user] closes and secures the hatch on [target]'s [affected.name] with \the [tool]."),
			SPAN_NOTE("You close and secure the hatch on [target]'s [affected.name] with \the [tool].")
		)
		affected.open = 0
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_WARN("[user]'s [tool.name] slips, failing to close the hatch on [target]'s [affected.name]."),
			SPAN_WARN("Your [tool.name] slips, failing to close the hatch on [target]'s [affected.name].")
		)
...
/datum/surgery_step/robotics/repair_brute
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_NOTE("[user] finishes patching damage to [target]'s [affected.name] with \the [tool]."),
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_WARN("[user]'s [tool.name] slips, damaging the internal structure of [target]'s [affected.name]."),
			SPAN_WARN("Your [tool.name] slips, damaging the internal structure of [target]'s [affected.name].")
		)
...
/datum/surgery_step/robotics/repair_burn
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		user.visible_message(
			...
			SPAN_NOTE("You finishes splicing new cable into [target]'s [affected.name].")
		)
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/obj/item/organ/external/affected = target.get_organ(target_zone)
		user.visible_message(
			SPAN_WARN("[user] causes a short circuit in [target]'s [affected.name]!"),
			SPAN_WARN("You cause a short circuit in [target]'s [affected.name]!")
		)
		target.apply_damage(rand(5,10), BURN, affected)
...
/datum/surgery_step/robotics/detatch_organ_robotic
	...
	begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			"[user] starts to decouple [target]'s [target.op_stage.current_organ] with \the [tool].",
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			SPAN_NOTE("[user] has decoupled [target]'s [target.op_stage.current_organ] with \the [tool]."),
			SPAN_NOTE("You have decoupled [target]'s [target.op_stage.current_organ] with \the [tool].")
		)
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			SPAN_WARN("[user]'s hand slips, disconnecting \the [tool]."),
			SPAN_WARN("Your hand slips, disconnecting \the [tool].")
		)
...
/datum/surgery_step/robotics/install_mmi
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message(
			SPAN_WARN("[user]'s hand slips."),
			SPAN_WARN("Your hand slips.")
		)
*/