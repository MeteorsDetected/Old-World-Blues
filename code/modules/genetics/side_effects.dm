...
/datum/genetics/side_effect/genetic_burn
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(1, "starts turning very red..")
...
/datum/genetics/side_effect/bone_snap
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(1, "'s limbs start shivering uncontrollably.")
...
/*/datum/genetics/side_effect/monkey
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(1, "has drool running down from [H.gender == MALE ? "his" : H.gender == FEMALE ? "her" : "their"] mouth.")
