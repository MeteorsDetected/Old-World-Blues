...
/datum/genetics/side_effect/genetic_burn
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(MESSAGE_VISIBLE, "starts turning very red..")
	...
	finish(mob/living/carbon/human/H)
		if(!H.reagents.has_reagent("dexalin"))
			for(var/organ_name in list(BP_CHEST,BP_L_ARM,BP_R_ARM,BP_R_LEG,BP_L_LEG,BP_HEAD,BP_GROIN))
				var/obj/item/organ/external/E = H.organs
				if(E) E.take_damage(0, 5, 0)
...
/datum/genetics/side_effect/bone_snap
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(MESSAGE_VISIBLE, "'s limbs start shivering uncontrollably.")
...
/*/datum/genetics/side_effect/monkey
	...
	start(mob/living/carbon/human/H)
		H.custom_emote(MESSAGE_VISIBLE, "has drool running down from [H.gender == MALE ? "his" : H.gender == FEMALE ? "her" : "their"] mouth.")
