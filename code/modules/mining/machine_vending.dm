...
//	new /datum/data/mining_equipment("Ore Scanner Pad",				/obj/item/weapon/ore_radar,			10,											50),
	...
	new /datum/data/mining_equipment("Banhammer",					/obj/item/weapon/banhammer,			10,											50),
...
//	new /datum/data/mining_equipment("Emergency Floodlight",		/obj/item/weapon/floodlight_diy, -1,												150,	1),
	...
	new /datum/data/mining_equipment("Motorcycle",					/obj/motorcycle, 					5,						1500),
...
//	new /datum/data/mining_equipment("Rapid-Railway-Fabricator",	/obj/item/weapon/rrf,	10,												600),
	new /datum/data/mining_equipment("First-Aid Kit",				/obj/item/storage/firstaid/adv,	30,								600),
...
//	new /datum/data/mining_equipment("Lazarus Injector",			/obj/item/weapon/lazarus_injector,		25,								1000),
	...
	new /datum/data/mining_equipment("Jackhammer",					/obj/item/weapon/pickaxe/jackhammer,		10,								500),
	new /datum/data/mining_equipment("Plasmacutter",				/obj/item/weapon/pickaxe/plasmacutter,		10,								500),
...
//	new /datum/data/mining_equipment("KA AoE Damage",				/obj/item/borg/upgrade/modkit/aoe/turfs,	15,							1500),
	...
	new /datum/data/mining_equipment("Diamond Drill",				/obj/item/weapon/pickaxe/diamonddrill,		10,								2000)
