...
//	new /datum/data/mining_equipment("Ore Box",						/obj/structure/ore_box,										-1,					150,	1),
	new /datum/data/mining_equipment("Emergency Floodlight",		/obj/item/weapon/floodlight_diy, 							99,					150,	1),
...
//	new /datum/data/mining_equipment("Material Scanners",			/obj/item/clothing/glasses/material,						15,					200),
	...
	new /datum/data/mining_equipment("Sculpting block",				/obj/structure/sculpting_block,								10,					200),
...
//	new /datum/data/mining_equipment("Drone Drill Upgrade",			/obj/item/device/mine_bot_ugprade,							10,					400),
	new /datum/data/mining_equipment("Industrial Drill Brace",		/obj/item/weapon/circuitboard/miningdrillbrace,								-1,					500,	1),
	new /datum/data/mining_equipment("Point Transfer Card",			/obj/item/weapon/card/mining_point_card,					99,					500),
...
//	new /datum/data/mining_equipment("Rapid-Railway-Fabricator",	/obj/item/weapon/rrf,										10,					600),
	new /datum/data/mining_equipment("Advanced First-Aid Kit",			/obj/item/storage/firstaid/adv,					30,					600),
...
//	new /datum/data/mining_equipment("Jaunter",						/obj/item/device/wormhole_jaunter,							20,					750),
	...
	new /datum/data/mining_equipment("100 Thalers",					/obj/item/weapon/spacecash/c100,							3,					1000),
...
//	new /datum/data/mining_equipment("Ore Summoner",				/obj/item/weapon/oreportal,									35,					800),
	...
	new /datum/data/mining_equipment("Industrial Drill Head",		/obj/item/weapon/circuitboard/miningdrill,								3,					1000,	1),
