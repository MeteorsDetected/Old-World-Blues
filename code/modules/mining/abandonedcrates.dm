...
/obj/structure/closet/crate/secure/loot/proc/generate_loot()
	...
	switch(loot)
		...
		if(59 to 60)
			new/obj/item/weapon/rig/merc/empty(src)
		if(61 to 62)
			for(var/i = 0, i < 12, ++i)
		...
		if(63 to 64)
			var/t = rand(4,7)
			for(var/i = 0, i < t, ++i)
				var/newcoin = pick(/obj/item/weapon/coin/silver, /obj/item/weapon/coin/silver, /obj/item/weapon/coin/silver, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/iron, /obj/item/weapon/coin/gold, /obj/item/weapon/coin/diamond, /obj/item/weapon/coin/phoron, /obj/item/weapon/coin/uranium, /obj/item/weapon/coin/platinum,/obj/item/weapon/coin/coin_selection)
				new newcoin(src)
		if(65 to 66)
