...
/client/proc/hide_most_verbs()
	...
	verbs.Remove(admin_verbs["hideable"])
...
ADMIN_VERB_ADD(/client/proc/player_panel, null, TRUE)
...
ADMIN_VERB_ADD(/client/proc/player_panel_new, R_ADMIN|R_MOD, TRUE)
...
ADMIN_VERB_ADD(/client/proc/colorooc, R_FUN)
...
// Some admin dickery that can probably be done better -- TLE
...
/client/proc/make_sound(var/obj/O in view())
	set category = "Special Verbs"
	set name = "Make Sound"
...
ADMIN_VERB_ADD(/client/proc/togglebuildmodeself, R_BUILDMODE)
...
ADMIN_VERB_ADD(/client/proc/change_human_appearance_admin, R_FUN)
...
ADMIN_VERB_ADD(/client/proc/change_human_appearance_self, R_FUN)
...
ADMIN_VERB_ADD(/client/proc/toggleattacklogs, null, TRUE)
...
ADMIN_VERB_ADD(/client/proc/toggleghostwriters, R_SERVER)
...
ADMIN_VERB_ADD(/client/proc/toggledrones, R_SERVER)
...
ADMIN_VERB_ADD(/client/proc/toggledebuglogs, null, TRUE)
...
ADMIN_VERB_ADD(/client/proc/togglemodelogs, null, TRUE)
...
ADMIN_VERB_ADD(/client/proc/man_up, R_FUN)
...
ADMIN_VERB_ADD(/client/proc/global_man_up, R_FUN)
