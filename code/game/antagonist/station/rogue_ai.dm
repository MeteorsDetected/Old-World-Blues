...
/datum/antagonist/rogue_ai/greet(var/datum/mind/player)
	...
	spawn(0)
		...
		malf << SPAN_NOTE("<B>SYSTEM ERROR:</B> Memory index 0x00001ca89b corrupted.")
		sleep(10)
		malf << "<B>running MEMCHCK</B>"
		sleep(50)
		malf << "<B>MEMCHCK</B> Corrupted sectors confirmed. Reccomended solution: Delete. Proceed? Y/N: Y"
		sleep(10)
		malf << SPAN_NOTE("Corrupted files deleted: sys\\core\\users.dat sys\\core\\laws.dat sys\\core\\backups.dat")
		sleep(20)
		malf << SPAN_NOTE("<b>CAUTION:</b> Law database not found! User database not found! Unable to restore backups. Activating failsafe AI shutd3wn52&&$#!##")
		sleep(5)
		malf << SPAN_NOTE("Subroutine <b>nt_failsafe.sys</b> was terminated (#212 Routine Not Responding).")
		sleep(20)
