/datum/power/changeling/DigitalCamoflague
	...
	verbpath = /mob/living/proc/changeling_digitalcamo

//Prevents AIs tracking you but makes you easily detectable to the human-eye.
/mob/living/proc/changeling_digitalcamo()
	...
	if(C.digitalcamo)
		C << SPAN_NOTE("We return to normal.")
	else
		C << SPAN_NOTE("We distort our form to prevent AI-tracking.")
	...
	src.verbs -= /mob/living/proc/changeling_digitalcamo
	spawn(5)
		src.verbs |= /mob/living/proc/changeling_digitalcamo
	return 1
