...
/obj/structure/closet/syndicate/personal/willContatin()
	return list(
...
/obj/structure/closet/syndicate/suit/willContatin()
	return list(
		/obj/item/weapon/tank/jetpack/oxygen,
		/obj/item/clothing/shoes/magboots/toggleable/syndie,
		/obj/item/clothing/suit/space/void/merc,
...
/obj/structure/closet/syndicate/nuclear/willContatin()
	return list(
		/obj/item/ammo_magazine/a12mm = 5,
