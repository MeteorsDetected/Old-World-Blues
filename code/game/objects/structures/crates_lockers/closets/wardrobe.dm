...
/obj/structure/closet/wardrobe/suit/New()
	...
	new /obj/item/clothing/under/charcoal_suit(src)
	new /obj/item/clothing/under/navy_suit(src)
	new /obj/item/clothing/under/burgundy_suit(src)
	new /obj/item/clothing/under/checkered_suit(src)
	new /obj/item/clothing/under/tan_suit(src)
