...
/obj/structure/closet/wardrobe/suit/New()
	...
	new /obj/item/clothing/under/with_suit/charcoal(src)
	new /obj/item/clothing/under/with_suit/navy(src)
	new /obj/item/clothing/under/with_suit/burgundy(src)
	new /obj/item/clothing/under/with_suit/checkered(src)
	new /obj/item/clothing/under/with_suit/tan(src)
	new /obj/item/clothing/under/sl_suit(src)
	new /obj/item/clothing/under/suit_jacket(src)
	new /obj/item/clothing/under/suit_female(src)
	new /obj/item/clothing/under/really_black(src)
	new /obj/item/clothing/under/librarian(src)
