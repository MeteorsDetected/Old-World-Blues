...
/obj/item/weapon/aiModule/safeguard
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 4)
...
/obj/item/weapon/aiModule/oneHuman
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 6) //made with diamonds!
...
/obj/item/weapon/aiModule/protectStation
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 4) //made of gold
...
/obj/item/weapon/aiModule/quarantine
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_BIO) = 2, TECH(T_MATERIAL) = 4)
...
/obj/item/weapon/aiModule/purge // -- TLE
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 6)
...
/obj/item/weapon/aiModule/tyrant // -- Darem
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 6, TECH(T_ILLEGAL) = 2)
...
/obj/item/weapon/aiModule/syndicate // Slightly more dynamic freeform module -- TLE
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_MATERIAL) = 6, TECH(T_ILLEGAL) = 7)
...
/obj/item/weapon/aiModule/robocop // -- TLE
	...
	origin_tech = list(TECH(T_DATA) = 4)
