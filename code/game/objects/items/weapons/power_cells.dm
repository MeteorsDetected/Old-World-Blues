...
/obj/item/weapon/cell/crap
	...
	origin_tech = list(TECH(T_POWER) = 0)
	maxcharge = 500
...
/obj/item/weapon/cell/high
	...
	origin_tech = list(TECH(T_POWER) = 2)
	icon_state = "hcell"
	maxcharge = 10000
...
/obj/item/weapon/cell/super
	...
	origin_tech = list(TECH(T_POWER) = 5)
	icon_state = "scell"
	maxcharge = 20000
...
/obj/item/weapon/cell/hyper
	...
	origin_tech = list(TECH(T_POWER) = 6)
	icon_state = "hpcell"
	maxcharge = 30000
...
/obj/item/weapon/cell/slime
	...
	origin_tech = list(TECH(T_POWER) = 2, TECH(T_BIO) = 4)
