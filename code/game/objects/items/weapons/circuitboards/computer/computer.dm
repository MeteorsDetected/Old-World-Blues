...
/obj/item/weapon/circuitboard/scan_consolenew
	...
	origin_tech = list(TECH(T_DATA) = 2, TECH(T_BIO) = 2)
...
/obj/item/weapon/circuitboard/teleporter
	...
	origin_tech = list(TECH(T_DATA) = 2, TECH(T_BLUESPACE) = 2)
...
/obj/item/weapon/circuitboard/cloning
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_BIO) = 3)
...
/obj/item/weapon/circuitboard/solar_control
	...
	origin_tech = list(TECH(T_DATA) = 2, TECH(T_POWER) = 2)
...
/obj/item/weapon/circuitboard/aifixer
	...
	origin_tech = list(TECH(T_DATA) = 3, TECH(T_BIO) = 2)
...
/obj/item/weapon/circuitboard/rcon_console
	...
	origin_tech = list(TECH(T_DATA) = 4, TECH(T_ENGINEERING) = 3, TECH(T_POWER) = 5)
