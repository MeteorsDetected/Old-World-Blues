...
/obj/item/weapon/circuitboard/mecha/gygax/targeting
	...
	icon_state = "mcontroller"
	origin_tech = list(TECH(T_DATA) = 4, TECH(T_COMBAT) = 4)
...
/obj/item/weapon/circuitboard/mecha/phazon
	origin_tech = list(TECH(T_DATA) = 4, TECH(T_BLUESPACE) = 3)
...
/obj/item/weapon/circuitboard/mecha/phazon/targeting
	...
	icon_state = "mcontroller"
	origin_tech = list(TECH(T_DATA) = 4, TECH(T_COMBAT) = 4, TECH(T_BLUESPACE) = 6)
